 ...
 */
const DEFAULT_OPTIONS: Required<VectorControlOptions> = {
  collapsed: true,
  position: 'top-right',
...
export class VectorControl implements IControl {
  ...
  private _options: Required<VectorControlOptions>;
   ...
   */
  private _emit(event: VectorControlEvent): void {
  ...
  private _createPanel(): HTMLElement {
    ...
    content.innerHTML = `
      <p class="vector-control-placeholder">
